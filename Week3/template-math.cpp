...
int main()
{
	...
	cout << v.average({2.0,2.0,2.0}) << endl;
	cout << i.average({5, 5, 5}) << endl;
	cout << d.average({5.0}) << endl;
	cout << d.average({1, 2, 3, 4}) << endl; //returns 2.5, which is correct.
	// cout << s.average({"5"}) << endl; cannot calculate the average of something of type string
