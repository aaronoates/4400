...
public:
	...
	{
		std::unique_ptr<int> ptr(new int (values_.begin())); //manual memory deallocation using smart pointers
		return *ptr;
	...
	{
		std::unique_ptr<int> ptr(new int (values_.end())); //manual memory deallocation using smart pointers
		return *ptr;
